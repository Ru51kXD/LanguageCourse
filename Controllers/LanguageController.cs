    ...
    public class LanguageController : Controller
    {
        ...
        public async Task<IActionResult> English()
        {
            ...
            WebApplication15.Models.LanguageInfoViewModel viewModel = new()
            {
                ...
                Facts = new List<WebApplication15.Models.LanguageFact>
                {
                    new() { Number = "01", Title = "Глобальное распространение", Text = "Английский является официальным языком в более чем 50 странах и широко используется как второй язык во многих других, что делает его настоящим глобальным средством коммуникации." },
                    new() { Number = "02", Title = "Богатый словарный запас", Text = "Английский язык имеет один из самых богатых словарных запасов среди всех языков мира, с более чем 1 миллионом слов, включая технические и специализированные термины." },
                    new() { Number = "03", Title = "Историческое влияние", Text = "На английский язык оказали влияние многие языки, включая латинский, французский, немецкий и скандинавские языки, что привело к его богатому и разнообразному словарному составу." },
                    new() { Number = "04", Title = "Диалекты и акценты", Text = "Английский язык имеет множество диалектов и акцентов, от британского и американского до австралийского, канадского, индийского и многих других, каждый со своими уникальными особенностями." }
                }
            };
        ...
        public async Task<IActionResult> Turkish()
        {
            ...
            WebApplication15.Models.LanguageInfoViewModel viewModel = new()
            {
                ...
                Facts = new List<WebApplication15.Models.LanguageFact>
                {
                    new() { Number = "01", Title = "Агглютинативный язык", Text = "Турецкий является агглютинативным языком, в котором слова формируются путем добавления суффиксов к корню слова, что позволяет создавать очень длинные и сложные слова из простых корней." },
                    new() { Number = "02", Title = "Гармония гласных", Text = "Как и казахский, турецкий подчиняется правилам гармонии гласных, что влияет на произношение и грамматику, делая язык более мелодичным и ритмичным." },
                    new() { Number = "03", Title = "Богатая литературная традиция", Text = "Турецкая литература имеет богатую историю, от османской поэзии до современных романов, признанных во всем мире. Орхан Памук, турецкий писатель, получил Нобелевскую премию по литературе в 2006 году." },
                    new() { Number = "04", Title = "Языковая реформа", Text = "В 1928 году Мустафа Кемаль Ататюрк провел масштабную языковую реформу, заменив арабское письмо на латиницу и очистив язык от многих арабских и персидских заимствований, что изменило облик турецкого языка." }
                }
            };
